...
| 3 | **bioRxiv preprint v1** (no endorsement needed; [13 §13.7](13-publication-strategy.md)) — structural identifiability of closure families on the 5-compartment topology (decided 2026-09-02); uses and cites the package | **JOSS gate-2 evidence begins**; on the §6.2 critical path |
